.. -*- mode: rst -*-
==========================================
 Keyboards for the Kildin Sami language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Kildin Sami language. The data and implementations
...
* http://giellatekno.uit.no/sjddoc/index.html
* https://giellalt.uit.no/tools/docu-sjd-manual.html
...
The Kildin Sami keyboard sources can be acquired using the `Giella SVN
